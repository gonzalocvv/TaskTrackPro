...
namespace TaskTrackPro.Backend.DataAccess.Migrations
{
    ...
    [Migration("20260605225923_AgregarRecursos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TareaRecurso", b =>
                {
                    ...
                    b.HasKey("TareaTitulo", "RecursoNombre");
            ...
            modelBuilder.Entity("TaskTrackPro.Backend.Dominio.Recurso", b =>
                {
                    b.Property<string>("Nombre")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TareaRecurso", b =>
                {
                    b.HasOne("TaskTrackPro.Backend.Dominio.Recurso", null)
                        .WithMany()
