...
{
    /// <inheritdoc />
    public partial class TablaUsuarioProyecto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProyectoUsuario", x => new { x.ProyectoNombre, x.UsuarioEmail });
                    table.ForeignKey(
                        name: "FK_ProyectoUsuario_Proyectos_ProyectoNombre",
                        column: x => x.ProyectoNombre,
                        principalTable: "Proyectos",
                        principalColumn: "Nombre",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProyectoUsuario_Usuarios_UsuarioEmail",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioTarea", x => new { x.UsuarioEmail, x.TareaTitulo });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProyectoUsuario_UsuarioEmail",
